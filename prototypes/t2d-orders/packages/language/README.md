...
- [src/t2d-orders.langium](src/t2d-orders.langium) - The grammar definition of your language
- [src/t2d-orders-module.ts](src/t2d-orders-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/t2d-orders-validator.ts](src/t2d-orders-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [src/syntaxes/t2d-orders.monarch.ts](src/syntaxes/t2d-orders.monarch.ts) - Monarch based syntax highlighting instructions.
- [syntaxes/t2d-orders.tmLanguage.json](syntaxes/t2d-orders.tmLanguage.json) - Textmate based syntax highlighting instructions.
